...
@Component({
  ...
  styleUrls: ['./change-password.component.css', '../../../../assets/css/FormStyleCss.css'],
  providers: [Title]
})
...
export class ChangePasswordComponent implements OnInit {
  ...
  constructor(public formBuilder: FormBuilder, public auth: AuthService, public route: Router, private spinner: NgxSpinnerService,
    ...
    {   
        ...
        password: new FormControl( "", Validators.compose([ Validators.required,  Validators.minLength(8), Validators.pattern(/^(?=.*\d)(?=.*[a-z]).{8,200}$/) ])),
        cnfpassword: new FormControl(  "", Validators.compose([Validators.required]))},
